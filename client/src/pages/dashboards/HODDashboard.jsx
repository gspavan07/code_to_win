...
import { FaGraduationCap, FaPeopleGroup, FaUpload, FaUser, FaUserGraduate, FaUserPlus } from "react-icons/fa6";
    ...
    return (
        <div className="grid md:grid-cols-4 gap-4">
            <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
                <div>
                    <p className="text-2xl font-bold flex justify-between">{currentUser.total_students}
                    </p>
                    <h2 className="text-gray-500 text-sm">Total Students</h2>
                </div>
                <div className="p-4 bg-violet-100 rounded-md"> <FaUserGraduate className="text-[#7839ee]" size={30} /> </div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
                <div>
                ...
                <div className="p-4 bg-sky-100 rounded-md"> <IoPeopleOutline color="blue" size={30} /> </div>
            </div>
            <div className="bg-white p-4 rounded-lg shadow flex justify-between items-center">
                <div>
                ...
                <div className="p-4 bg-green-100 rounded-md"> <FaGraduationCap color="green" size={30} /> </div>
    ...
    return (
        ...
        <div className="w-full  bg-white  rounded-lg shadow mt-10">
            ...
            <div className="w-full flex  p-6 items-center justify-between">
                ...
                <button className="bg-blue-500 md:px-3 md:py-2 p-1.5 text-sm md:text-base  rounded-lg text-white flex items-center md:gap-2 gap-1"
                    onClick={() => setAddFacultyModal(true)}
                ><FaUserPlus />Add <span className="hidden md:block">Faculty</span></button>
            </div>
                ...
                <table className="w-full bg-white  overflow-hidden  md:text-sm text-xs text-gray-900 ">
                    <thead className="bg-gray-100 text-left  w-full ">
                        <tr >
                            ...
                            <th className="md:p-3 p-2 sr-only md:not-sr-only font-light ">STATUS</th>
                    ...
                    <tbody  >
                        ...
                        {facultyList.map((faculty, index) => (
                            <tr key={index} className="border-gray-100 hover:bg-gray-50 text-center md:text-left">
                                ...
                                <td className="py-5 px-3 flex  items-center gap-6 text-black font-medium text-left">
                                    ...
                                    <div className="flex flex-col text-sm">
                                        {faculty.name}
                                        <span>{faculty.name}@aec.edu.in</span></div>
                                </td>
                                <td>Employee</td>
                                <td>4th AIML</td>
                                <td className="sr-only md:not-sr-only"><span className="bg-green-100 text-green-600 px-3 rounded-2xl py-1">Active</span></td>
                                <td ><button className="bg-blue-500 px-4 py-1 cursor-pointer  rounded-md text-white ">Update</button></td>
                            </tr>))}
                    </tbody>
                </table>
        ...
        <>
            ...
            <div className="flex bg-gray-50">
                ...
                <div className="flex-1 md:ml-4">
                    ...
                    {/* Stats Grid */}
                    <div className=" w-full p-2 sm:p-4 md:p-8 lg:p-20">
                        <button
